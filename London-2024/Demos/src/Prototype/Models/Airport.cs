...
public partial class Airport
{
    ...
    public virtual ICollection<ScheduledFlight> ScheduledFlightDestinationAirportCodeNavigations { get; set; } = new List<ScheduledFlight>();

    public virtual ICollection<ScheduledFlight> ScheduledFlightOriginAirportCodeNavigations { get; set; } = new List<ScheduledFlight>();
}
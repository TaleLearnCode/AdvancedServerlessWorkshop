...
variable "customer" {
  type        = string
  description = "The customer that the resources are being created for."
}

variable "random_identifier" {
  type        = number
  description = "Random number to append to the resource name."
}
...
variable "telemetry_function_name" {
  type        = string
  default     = "tlm"
  description = "The name of the telemetry function."
}